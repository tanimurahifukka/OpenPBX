  ...
  return (
    <section className="space-y-3 rounded-lg border border-slate-200 bg-white p-4">
      ...
      <div className="grid grid-cols-[1fr_auto_auto_auto] gap-2">
        ...
        />
        <button onClick={call} type="button" className="rounded bg-emerald-600 px-3 py-1.5 text-xs font-semibold text-white">
          発信
        </button>
        <button onClick={answer} type="button" className="rounded bg-blue-600 px-3 py-1.5 text-xs font-semibold text-white">
          応答
        </button>
        <button onClick={hangup} type="button" className="rounded bg-red-600 px-3 py-1.5 text-xs font-semibold text-white">
          切る
        </button>
      </div>
