  ...
  return (
    <div className="mx-auto max-w-sm space-y-4 py-12">
      ...
      <form action={loginAction} className="space-y-3 rounded-lg border border-slate-200 bg-white p-4">
        ...
        {sp.err && <p className="text-xs text-danger">ログインに失敗しました。</p>}
        <button
          type="submit"
          className="w-full rounded-md bg-primary px-3 py-1.5 text-sm font-semibold text-white hover:bg-primary-500"
        >
          ログイン
        </button>
